...
Rejected a frontend-only/localStorage prototype: calendar + Gantt + **CSV** import (**ICS cancelled — moved to release-cancelled**) need a real data model, backup story, and per-user isolation from day one.
