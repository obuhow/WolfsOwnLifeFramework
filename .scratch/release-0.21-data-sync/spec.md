...
Feature slug: `release-0.21-data-sync`
Tracker: local markdown
Depends on: `release-0.2-methodology` data model and existing import flows
...
- Тикеты релиза лежат в `.scratch/release-0.21-data-sync/issues/` и нумеруются вертикальными срезами.
