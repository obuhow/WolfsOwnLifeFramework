# WOLF Release 0.4 — Отменённая демо-песочница

Status: `wontfix`
Feature slug: `release-0.4-cancelled-demo-sandbox`
...
### 16 — Импорт ICS → Записи времени (from release-0.1-calendar-os)

**Original Status:** `ready-for-agent` → **Cancelled: `wontfix`**

**Reason for cancellation:** 
- ICS import was planned as a one-shot feature for initial migration
- User decided to use xlsx import (release-0.2-methodology ticket 11) as the primary historical data import mechanism instead
...
- Release 0.1: `.scratch/release-0.1-calendar-os/spec.md` (original scope including ICS)
- Release 0.2: `.scratch/release-0.2-methodology/spec.md` (xlsx import as replacement, ticket 11)
