...
public class FocusReviewService {
    ...
    public ReviewResponse review(Authentication auth, Long id) {
    ...
    @Transactional(readOnly = true)
    public PreviewResponse preview(Authentication auth, Long id, AllocationRequest request) {
        FocusSession session = ownedSession(auth, id);
        Plan plan = plan(session, auth, request.allocations(), false);
        return plan.preview();
    }
    @Transactional
    public PreviewResponse apply(Authentication auth, Long id, AllocationRequest request) {
        FocusSession session = ownedSession(auth, id);
    ...
    @Transactional
    public PreviewResponse revert(Authentication auth, Long id) {
        FocusSession session = ownedSession(auth, id);
